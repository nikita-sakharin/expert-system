...
index((table), 1, tabling, tabling).
index((current_table), 2, tabling, tabling).
index((abolish_all_tables), 0, tabling, tabling).
index((abolish_table_subgoals), 1, tabling, tabling).
index((start_tabling), 2, tabling, tabling).
