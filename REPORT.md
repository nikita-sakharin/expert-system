...
Опишите результаты концептуализации предметной области:
 - выделенные понятия
 - *межсвязиду ними, тип получившейся онтологии (словарь, сеть, иерархия и т.д.):* в результате концепуализации предметной области получившаяся онтология имеет вид иерархии
